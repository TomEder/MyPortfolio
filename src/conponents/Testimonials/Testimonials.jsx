...
const Testimonials = () => {
  ...
  return (
    <div className="bg-tommy-background flex flex-col items-center justify-center text-center h-screen p-16 md:p-1 md:h-screen overflow-hidden border-b-4">
      <h2 className="text-3xl md:text-4xl text-gray-800 mb-6 md:mb-10 overflow-hidden">
            ...
            <div key={index} className="p-4 h-full">
              <div className="bg-gray-900 text-white border border-gray-700 rounded-2xl shadow-md p-6 h-full flex flex-col justify-between items-center">
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-sm h-32 md:h-40 overflow-y-auto custom-scrollbar my-5">
                    "{testimonial.quote}"
                  </div>
                </div>
              </div>
